        ...
        <div class="row">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active fw-bold" aria-current="page"><i class="fa fa-layer-group me-1"></i>Category Edit</li>
                </ol>
            </nav>
        </div>

        <h3 class="fw-bold text-secondary mt-5">Category Edit</h3>

        <form action="" method="POST">
            <div class="mb-3 mt-4">
                <label for="categoryName" class="form-label fw-bold">Category Name</label>
                <input type="text" class="form-control" name="categoryName" id="categoryName" placeholder="Enter Category Name . . ." value="<?php echo $category['name'] ?>">
            </div>
